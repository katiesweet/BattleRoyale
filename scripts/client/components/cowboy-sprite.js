MyGame.components.CowboySprite = function(spec) {
    ...
    that.updateRotationAnimation = function(rotation) {
        ...
        else if (scaledRotation > Math.PI / 8 && scaledRotation <= 3 * Math.PI / 8){
            that.rotateAnimationNumber = 4;
        }
        else if (scaledRotation > 3 * Math.PI / 8 && scaledRotation <= 5 * Math.PI / 8) {
            that.rotateAnimationNumber = 5;
        }
        else if (scaledRotation > 5 * Math.PI / 8 && scaledRotation <= 7 * Math.PI / 8) {
            that.rotateAnimationNumber = 6;
        }
        else if (scaledRotation > 7 * Math.PI / 8 && scaledRotation <= 9 * Math.PI / 8) {
            that.rotateAnimationNumber = 7;
        }
        else if (scaledRotation > 9 * Math.PI / 8 && scaledRotation <= 11 * Math.PI / 8) {
            that.rotateAnimationNumber = 8;
        }
        else if (scaledRotation > 11 * Math.PI / 8 && scaledRotation <= 13 * Math.PI / 8) {
            that.rotateAnimationNumber = 9;
        }
        else if (scaledRotation > 13 * Math.PI / 8 && scaledRotation <= 15 * Math.PI / 8) {
